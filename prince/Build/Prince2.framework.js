...
var ASM_CONSTS = {
  4161136: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4161197: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4161261: function() {return Module.webglContextAttributes.powerPreference;},  
 4161319: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4161374: function($0) {performance.now = function() { return $0; };},  
 4161422: function($0) {performance.now = function() { return $0; };},  
 4161470: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _Hello() {
      json = `Send xAPI Statement`
      message = document.getElementById("message");
      message.innerHTML = json;
      console.log(json);
      window.parent.parent.postMessage("trigger_xapi", "*");
    }
  ...
  function _WebGLGetPosition() {
          if(document.microphoneNative === undefined)
              return 0;
          return document.microphoneNative.microphone.getPosition();
      }

  function _WebGLInit(callbackJSON) {
          if (document.microphoneNative != undefined)
              return;
  ...
  function _WebGLIsRecording() {
          if(document.microphoneNative === undefined)
              return 0;
          return document.microphoneNative.microphone.isRecording() ? 1 : 0;
      }

  function _WebGLMicEnd() {
          if(document.microphoneNative === undefined)
              return;
          document.microphoneNative.microphone.end();
      }

  function _WebGLMicStart(deviceId, frequency, lengthSec) {
          if(document.microphoneNative === undefined)
              return;
          document.microphoneNative.microphone.start(document.microphoneNative.getStringFromPtr(deviceId), frequency, 1, lengthSec);
      }

  var webSocketManager = {instances:{},lastId:0,onOpen:null,onMessage:null,onError:null,onClose:null};
  function _WebSocketAddSubProtocol(instanceId, protocolPtr)
      {
  ...
  function _WebSocketAllocate(urlPtr, binaryTypePtr)
      {
  ...
  function _WebSocketSendStr(instanceId, stringPtr)
      {
          var instance = webSocketManager.instances[instanceId];
          if (!instance) return -1;
          if (instance.ws === null) return -3;
  ...
  function _WebSocketSetOnMessageStr(callback)
      {
...
var asmLibraryArg = {
  ...
  "WebGLGetDeviceCaps": _WebGLGetDeviceCaps,
  "WebGLGetDeviceData": _WebGLGetDeviceData,
  "WebGLGetPosition": _WebGLGetPosition,
  "WebGLInit": _WebGLInit,
  "WebGLInitSamplesMemoryData": _WebGLInitSamplesMemoryData,
  "WebGLIsPermitted": _WebGLIsPermitted,
  "WebGLIsRecording": _WebGLIsRecording,
  "WebGLMicEnd": _WebGLMicEnd,
  "WebGLMicStart": _WebGLMicStart,
  ...
  "WebSocketSendStr": _WebSocketSendStr,
  ...
  "WebSocketSetOnMessageStr": _WebSocketSetOnMessageStr,
...
unexportedRuntimeFunction('webSocketManager', false);
unexportedRuntimeFunction('webSocketManager__user', false);
